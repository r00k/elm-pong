...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var displayMoveable = F2(function (moveable,shape) {
      return A2($Graphics$Collage.move,{ctor: "_Tuple2",_0: moveable.x,_1: moveable.y},A2($Graphics$Collage.filled,$Color.white,shape));
   });
   ...
   var updatePosition = F2(function (t,_p1) {    var _p2 = _p1;return _U.update(_p2,{x: _p2.x + _p2.vx * t,y: _p2.y + _p2.vy * t});});
   ...
   var stepPlayer = F4(function (t,dir,points,player) {
      ...
      var player$ = A2(updatePosition,t,_U.update(player,{vy: $Basics.toFloat(dir) * 200}));
   ...
   var stepGame = F2(function (input,game) {
      ...
      var state = _p7.state;
      var ball = _p7.ball;
      var player1 = _p7.player1;
      var player2 = _p7.player2;
   ...
   var _p9 = {ctor: "_Tuple2",_0: 600,_1: 400};
   var gameWidth = _p9._0;
   var gameHeight = _p9._1;
   var pongCourt = A2($Graphics$Collage.filled,pongGreen,A2($Graphics$Collage.rect,gameWidth,gameHeight));
   var display = F2(function (_p11,_p10) {
      var _p12 = _p11;
      var _p13 = _p10;
      var _p15 = _p13.player2;
      var _p14 = _p13.player1;
      var scores = A2(txt,$Text.height(50),A2($Basics._op["++"],$Basics.toString(_p14.score),A2($Basics._op["++"],"  ",$Basics.toString(_p15.score))));
      ...
      gameHeight,
      _U.list([pongCourt
              ,A2(displayMoveable,_p13.ball,A2($Graphics$Collage.oval,15,15))
              ,A2(displayMoveable,_p14,A2($Graphics$Collage.rect,10,40))
              ,A2(displayMoveable,_p15,A2($Graphics$Collage.rect,10,40))
   ...
   return _elm.Main.values = {_op: _op
                             ...
                             ,msg: msg
                             ,pongCourt: pongCourt
                             ,displayMoveable: displayMoveable
                             ,display: display
                             ,main: main};
};
